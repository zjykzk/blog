...
[[wiki/concepts/五大思维三层架构]] 把分类、分层、排序、关联和可视化都看作结构化思维的操作动作。分类思维是其中最基础的一种：它负责选维度并切开对象；结构化思维还要继续把分类结果放进层级、因果链、逻辑树或流程图，让系统思维、逻辑思维、创造性思维和批判性思维的输入都能落到同一张可处理的结构上。^[inferred]
