...
也就是说，概率思维的价值，不只是预测，而是约束判断的刻度，降低伪精确、故事绑架与过度确定。

参考：[[wiki/topics/Probability]]

## Understanding Use

mental models 也可以看成 [[wiki/concepts/Understanding]] 的结构模板：新信息进入时，已有模型提供“差不多像”的承接结构；模型越多，理解云越容易横向展开。^[inferred]
