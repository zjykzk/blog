...
In AI-assisted frontend work, this same principle applies to the assistant. [[wiki/sources/Reducing Friction in AI-Assisted Development Source Guide]] argues that fast generated output can be a trap if review and rework consume the time saved.
