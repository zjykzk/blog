...
- [[wiki/sources/面向 LLM 的清晰表达 Source Guide]]
...
## Source mismatch to resolve later

当前旧文件存在一处历史错位：

- `pages/Agent tool.md` 里实际记录的是 think tool 摘录
- `pages/llm.md` 里实际记录的是 router / adapter 摘录

第一轮先在 wiki 层完成整理，不急着改名旧文件。
