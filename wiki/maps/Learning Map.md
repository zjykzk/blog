...
- [[wiki/topics/Learning Methodology]]——七条动作原则
...
- [[wiki/sources/热力学第二定律与时间箭头 Source Guide]]——中文物理教学问答：从第二定律最直观表述、热量流向、玻尔兹曼熵，追问到“为什么熵增”（概率/组合），再深钻到时间箭头、低熵初始条件（Past Hypothesis）与粗粒化
...
- 思维模型（待建：`wiki/topics/Mental Models`）
- 写作与表达（待建）
- 产品与认识论（见 `notes/20260426T012506--产品的秩__rank.org`）
